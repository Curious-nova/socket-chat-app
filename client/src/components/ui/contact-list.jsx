  ...
  return (
    <div className='mt-5'>
      {contacts.map((contact) => (
        <div
          key={contact._id}
          className={`pl-10 py-2 transition-all duration-300 cursor-pointer ${selectedChatData && selectedChatData._id === contact._id ? "bg-[#8417ff] hover:bg-[#bb7fff]" : "hover:bg-[#b778ff]"}`}
                ...
                {contact.image ? (
                  ...
                  <div
                    className={` 
                      ...
                      uppercase h-10 w-10 border-[1px] text-lg flex items-center justify-center rounded-full ${getColor(contact.color)}`}
                  >
                    {contact.firstName
